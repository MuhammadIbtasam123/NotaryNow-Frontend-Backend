      ...
      <Box className="text-section">
        <Box className="text-section-display">
          ...
          <Typography variant="body1" gutterBottom className="utility-section">
            "Skip the trip to find a notary. Notarize your document online with
            ease – upload, verify, and connect with a notary in minutes."
          </Typography>

          <Box className="button-section">
            <Typography variant="button" display="block" gutterBottom>
              <Link to="/SignupNotary">
                <Button className="notarize-button">
            ...
            <Typography variant="button" display="block" gutterBottom>
              <Link to={"/LoginNotary"}>
                <Button variant="outlined" className="notary-button">
                  Continue as Notary
                </Button>
              </Link>
            </Typography>
